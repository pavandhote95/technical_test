              ...
              child: _products.isEmpty
                  ...
                  : LayoutBuilder(
                      builder: (context, constraints) {
                        ...
                        final itemsToShow = _showAllProducts
                            ? _products
                                          ...
                                          child: Stack(
                                            children: [
                                              ...
                                              Positioned(
                                                ...
                                                left: 115,
                                                bottom:
                                                    _keyboardActive ? 10 : 68,
                                                child: IconButton(
                                                  icon: Image.asset(
                                                    'assets/images/delete.png',
                                                    width: _keyboardActive
                                                        ? 15
                                                        : 35,
                                                    height: _keyboardActive
                                                        ? 15
                                                        : 35,
                                                  ),
                                                  onPressed: () =>
              ...
              child: _accessories.isEmpty
                  ...
                  : LayoutBuilder(
                      builder: (context, constraints) {
                        ...
                        final itemsToShow = _showAllAccessories
                            ? _accessories
                            : _accessories.take(2).toList();
                        final searchText = _searchController.text.toLowerCase();
                        final filteredAccessories =
                            itemsToShow.where((accessory) {
                          return accessory['name']!
                              .toLowerCase()
                              .contains(searchText);
                        }).toList();

                        return filteredAccessories.isEmpty
                            ? Center(
                                child: Text("No accessories found",
                                    style: TextStyle(
                                        fontSize: 16, color: Colors.grey)))
